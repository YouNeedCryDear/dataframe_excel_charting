...
test_sheet.countryTAMAnalysis("CTAP1", base_sheet_name="test data", country="PER")
test_sheet.countryTAMAnalysis("CTAP2", base_sheet_name="test data", country="BRA")
test_sheet.networkAnalysis("NA1", base_sheet_name="test data", partner_name="Telefonia")
test_sheet.networkAnalysis("NA2", base_sheet_name="test data", partner_name="ELCON")
workbook.close()